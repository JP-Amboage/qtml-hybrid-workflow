...
def hyperband(
    ...
    for s in range(s_max, -1, -1):
        ...
        for i in range(0, s + 1, 1):
            ...
            r_i = round(r * (eta**i))
            print((n_i, r_i))
            L, T = run_then_return_validation_loss(comm=comm,
                                                   T=T,
                                                   size=size,
                                                   r_prev=r_prev,
                                                   r_i=r_i)
...
def main(dir_name, seed, model_name, save_models, r, eta):
    ...
    if model_name == 'cifar10_tf':
        ...
        if model_name != 'lstm':
            print(
                "WARNING: model_name not valid -> using lstm as default choice")
