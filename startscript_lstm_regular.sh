...
#SBATCH --job-name=R-LSTM
#SBATCH --account=deepext
#SBATCH --mail-user=
#SBATCH --mail-type=ALL
#SBATCH --output=R-LSTM.out
#SBATCH --error=R-LSTM.err
...
srun --mpi=pspmix python3 -u MPI_regular_hyperband.py --dir_name=saved_models_r_lstm --seed=0 --model_name=lstm --r=300